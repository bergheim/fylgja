...
class CountWidgetProvider : AppWidgetProvider() {
    ...
    private fun buildCounterView(context: Context, habit: Habit): RemoteViews {
        ...
        rv.setInt(R.id.widget_image, "setBackgroundColor", bgColor)
        rv.setTextViewText(R.id.widget_text, "${habit.icon}\n${habit.todayCount()}")
        rv.setTextColor(R.id.widget_text, Color.BLACK)
        ...
        rv.setOnClickPendingIntent(R.id.widget_text, pi)
